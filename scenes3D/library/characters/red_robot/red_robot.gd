...
var blast_scene: PackedScene = preload("res://scenes3D/library/characters/red_robot/laser/impact_effect/impact_effect.tscn")
...
# Aplica dano localizado ao player: raio contra as hitboxes de MEMBRO do player
