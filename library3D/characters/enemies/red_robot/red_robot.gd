...
func _ready() -> void:
	...
	ai = preload("res://library3D/characters/enemies/red_robot/IA/red_robot_ai.gd").new()
	ai.name = "IA"
	add_child(ai)
...
func _setup_limb_colliders() -> void:
	...
	# LimbConfig (na pasta do modelo: res://library3D/characters/enemies/red_robot/limb_config.json;
