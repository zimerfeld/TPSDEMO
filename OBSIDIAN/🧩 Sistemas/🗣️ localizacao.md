...
`language_changed` (`_refresh_member_overlays`/`_refresh_aux_labels`) — ver [[🗿 biblioteca-de-modelos]].
...
`language_changed` (antes ficavam presos no idioma da última construção) — ver [[🩸 dano-localizado]].
...
Relacionado: [[🎬 fluxo-de-cenas]], [[🐞 debug-overlay]], [[⚡ performance-hud]],
[[🧭 main-gd]].
