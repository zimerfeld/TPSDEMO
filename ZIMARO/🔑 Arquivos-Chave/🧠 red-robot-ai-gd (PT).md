...
| `flee_speed` | `2.0 m/s` | Velocidade ao abrir espaço (ajustada à passada — ver [[🤖 inimigos (PT)|🤖 inimigos]] 2026-07-08) |
...
- **Recuo (FLEE):** quando `decide(...) == FLEE`, `movement_plan` devolve `direction = -forward`
  ...
  mirando/atirando à parte. Ver [[🤖 inimigos (PT)|🤖 inimigos]] ("Locomoção realista").
