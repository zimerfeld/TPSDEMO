...
## 🔗 Ligações
- [[🚀 Build Windows (Prod) (PT)|🚀 Build Windows (Prod)]] — gerar o `build/windows/ZIMARO.exe` antes de publicar
- [[💻 Rodar no Editor (Dev) (PT)|💻 Rodar no Editor (Dev)]] · [[🏠 Home (PT)|🏠 Home]] · [[📌 Backlog (PT)|📌 Backlog]]
