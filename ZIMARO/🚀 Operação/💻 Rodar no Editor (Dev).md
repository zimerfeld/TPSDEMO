...
`main` ([[🧭 main-gd]], roteador), que abre o **menu** — ver [[🎬 fluxo-de-cenas]].
...
2. Abrir o projeto no editor Godot 4.6.2 e rodar (F5). Navegação: menu → chooseplayer → levels →
   level_1/level_2 · settings · developer → models ([[🎬 fluxo-de-cenas]]).
3. **Multiplayer em loopback (2 instâncias no MESMO PC)** — protocolo completo em
   [[🧪 teste-salas-multiplayer]] (Teste A, ✅ validado em campo 2026-07-02):
...
- **Nunca commitar/publicar** — deixar para o usuário revisar (GitFlow; branch ativa em [[📌 Backlog]]).
- Ao fim de tarefa com impacto no usuário: atualizar READMEs + cofre e rodar o build de produção
  ([[🚀 Build Windows (Prod)]]); zerar erros/warnings.
...
- **Tela cinza no cliente ao entrar na sala:** template/scene-cache — ver [[🚪 salas]] ("salas
  nascem limpas"); mais sintomas na tabela do [[🧪 teste-salas-multiplayer]].

## 🔗 Ligações
- [[🚀 Build Windows (Prod)]] — gerar o `.exe` de produção
- [[🧪 teste-salas-multiplayer]] · [[🚪 salas]] · [[🌐 multiplayer]] · [[🎬 fluxo-de-cenas]]
- [[🏠 Home]] · [[📌 Backlog]]
