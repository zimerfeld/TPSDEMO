...
## 🔗 Ligações
- [[💻 Rodar no Editor (Dev) (PT)|💻 Rodar no Editor (Dev)]] — rodar/desenvolver localmente antes do build
- [[📦 Atualizar Asset da Release (GitHub) (PT)|📦 Atualizar Asset da Release (GitHub)]] — publicar o `.exe` gerado na página de releases
- [[🧱 recursos-nativos-godot (PT)|🧱 recursos-nativos-godot]] · [[🎬 fluxo-de-cenas (PT)|🎬 fluxo-de-cenas]]
