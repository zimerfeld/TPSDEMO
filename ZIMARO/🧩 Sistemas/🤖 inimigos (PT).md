...
> **Recuo (FLEE):** além dos 3 estados, uma decisão da [[🧠 red-robot-ai-gd (PT)|IA]] sobrepõe
...
> A recarga efetiva (1º e próximos tiros) vem da [[🧠 red-robot-ai-gd (PT)|IA]]
...
- Ver [[🩹 enemy-health-bar-gd (PT)|🩹 enemy-health-bar-gd]]
...
- **Cápsula de locomoção auto-ajustada (2026-07-03):** após `build_for`, `red_robot.gd` chama
  ...
  [[🩸 dano-localizado (PT)|🩸 dano-localizado]] ("Auto-fit da cápsula de locomoção por modelo").
...
(parâmetros/limites virão numa tela dedicada — ver [[📌 Backlog (PT)|📌 Backlog]] P1.5):
...
entrada da Area) → reage a neutros provocados que viram aliados. Ver [[⚔️ facções (PT)|⚔️ facções]].
...
não sobem/descem em sincronia. Ver [[🧠 red-robot-ai-gd (PT)|🧠 red-robot-ai-gd]].
...
- [[🧠 red-robot-ai-gd (PT)|🧠 red-robot-ai-gd]]
