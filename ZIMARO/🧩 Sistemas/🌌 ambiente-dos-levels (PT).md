...
> **60 FPS cravados** nos dois levels, inclusive em combate. Relacionado: [[🚪 salas (PT)|🚪 salas]],
> [[🧩 templates-de-level (PT)|🧩 templates-de-level]], regra de otimização ([[optimize-when-adding-scene-elements]]).
...
Mesma linguagem de cor das sessões online (HOST = âmbar / CLIENTE = ciano — ver [[🚪 salas (PT)|🚪 salas]]).
