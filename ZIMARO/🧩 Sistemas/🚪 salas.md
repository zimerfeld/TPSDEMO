...
> player nasce nela. Relacionado: [[🌐 multiplayer]], [[🛰️ hospedagem-online]],
> [[🎬 fluxo-de-cenas]].
>
> 🧪 **Para validar em campo:** ver [[🧪 teste-salas-multiplayer]] (roteiro loopback → LAN → internet).
> Revisão de código do fluxo feita em 2026-07-01 — **consistente, sem bugs conhecidos**; falta a execução.
