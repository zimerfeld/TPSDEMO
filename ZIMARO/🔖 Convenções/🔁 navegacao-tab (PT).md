...
> [[🐞 debug-overlay (PT)|🐞 debug-overlay]], [[🎬 fluxo-de-cenas (PT)|🎬 fluxo-de-cenas]], [[⌨️ fluxo-de-input (PT)|⌨️ fluxo-de-input]], [[📌 ancoragem-ui (PT)|📌 ancoragem-ui]].
...
A linha branca **"Tab"** do [[🐞 debug-overlay (PT)|🐞 debug-overlay]] é calculada por `DebugOverlay._compute_tab_indices`:
...
| **`Locale.tr_key`** | `tr_key(key) → String` (autoload [[🗣️ localizacao (PT)|🗣️ localizacao]]) | ~84 chamadas (todas as telas com texto dinâmico/OptionButton) |
